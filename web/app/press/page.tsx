...
export default function PressPage() {
  const press = [
    {
      ...
      title: 'malAI Raises $5M Series A to Revolutionize Thai Wedding Industry',
      excerpt: 'malAI, แพลตฟอร์มที่ใช้ AI ช่วยวางแผนงานฉลองไทย ได้รับการลงทุนรอบ Series A จำนวน 50 ล้านบาท...',
      link: '#',
      image: '📰'
    },
    {
      ...
      excerpt: 'malAI ติดอันดับ Top 10 สตาร์ทอัพที่น่าจับตามองที่สุดในประเทศไทย ประจำปี 2024...',
      link: '#',
      image: '🏆'
    },
    {
      ...
      excerpt: 'แพลตฟอร์ม malAI กำลังเปลี่ยนวิธีการจัดงานฉลองไทยด้วยเทคโนโลยี AI และการคัดกรองพาร์ทเนอร์อย่างเข้มงวด...',
      link: '#',
      image: '📱'
    },
    {
      ...
      excerpt: 'malAI ไม่ได้แค่ใช้เทคโนโลยี แต่ยังเคารพและอนุรักษ์วัฒนธรรมไทยผ่านการคัดกรองและอบรมพาร์ทเนอร์...',
      link: '#',
      image: '🎭'
    }
  ];
  ...
  const milestones = [
    ...
    { date: 'เม.ย. 2024', event: 'เปิดตัว Malai Copilot™ AI', value: 'AI Launch' },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-800/80 max-w-2xl mx-auto">
              ติดตามข่าวสาร รางวัล และความก้าวหน้าของ malAI
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-500 to-amber-600 text-white rounded-2xl p-8 text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <a href="mailto:press@malai.app" className="bg-amber-700 text-white px-6 py-3 rounded-lg hover:bg-amber-800 transition font-semibold">
                ติดต่อทีมสื่อสาร
              </a>
            </div>
          </div>
